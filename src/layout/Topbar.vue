<template>
    <nav class="bg-gray-200 primary-bg">
        <div
            ...
            <div class="flex items-center gap-2 text-sm md:text-sm">
                <svg-icon :name="'free-return'" class="w-4 h-6 flex" />
                <span class="whitespace-nowrap">30 Days Free Returns | T&C Apply</span>
            </div>
        </div>
    </nav>
</template>
