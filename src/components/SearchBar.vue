<template>
    <div class="relative w-full max-w-md">
        ...
        <input type="text" placeholder="Search..."
            class="w-full py-2 pl-4 pr-12 text-gray-700 text-sm rounded-full border-0 bg-gray-200 text-gray-900 placeholder-gray-400 dark:bg-[#282828] dark:text-white" />
