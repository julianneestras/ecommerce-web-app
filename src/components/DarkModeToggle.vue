<template>
    <button id="theme-toggle" type="button" @click="toggleTheme"
        class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none border-1 border-gray-300 focus:ring-gray-200 rounded-full text-sm p-2.5">
